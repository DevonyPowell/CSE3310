...
#endif
{
    ...
    msg->index = 0;
    ////////////////////////////////////////////////////////////////////////
    msg->userAge = 23;			// added field; age should now be 23
    ////////////////////////////////////////////////////////////////////////

    if (ownID == TERMINATION_MESSAGE) {
        snprintf (buf, MAX_MSG_LEN, "Termination message.");
    } else {
        snprintf (buf, MAX_MSG_LEN, "Hi There, I will send you messages forever.");
    }
    ...
    for (i = 1; ; i++)  // for loop is always true; chatter will publish forever
    {  
        msg->index = i;
        ...
        cout << "Writing message: \"" << msg->content << "\"" << endl;
	/////////////////////////////////////////////////////////////
	cout << "Added field (userAge): " << msg->userAge << endl;
	/////////////////////////////////////////////////////////////
        status = talker->write(*msg, userHandle);
        checkStatus(status, "Chat::ChatMessageDataWriter::write");
        sleep (1); /* do not run so fast! */
