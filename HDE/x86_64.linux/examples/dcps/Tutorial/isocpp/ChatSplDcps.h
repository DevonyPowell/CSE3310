...
extern  c_bool __Chat_ChatMessage__copyIn(c_base base, class Chat::ChatMessage *from, struct _Chat_ChatMessage *to);
...
extern  c_bool __Chat_NameService__copyIn(c_base base, class Chat::NameService *from, struct _Chat_NameService *to);
...
extern  c_bool __Chat_NamedMessage__copyIn(c_base base, class Chat::NamedMessage *from, struct _Chat_NamedMessage *to);
